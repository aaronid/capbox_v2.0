                                                ...
                                                <!-- article-content -->
                                                  ...
                                                  <tbody>
													<tr >
                                                      ...
                                                      <td align="center" width="10%" ><?php $rurl="/capbox_test/avoir_liste.php"; urld($rurl); ?><img src="images/icones/police-icone-9426-32.png" align="center" width="32" height="32" /><br />
      ...
      <tr>
      	<td>
      		<div>
				...
				<input type="radio" name="typeMontant" value="<?php echo Profil::$TYPE_MONTANT_HT; ?>" <?php if ($typeMontant == Profil::$TYPE_MONTANT_HT) echo "checked"; ?> >Montant HT
				<input type="radio" name="typeMontant" value="<?php echo Profil::$TYPE_MONTANT_TTC; ?>" <?php if ($typeMontant == Profil::$TYPE_MONTANT_TTC) echo "checked"; ?> >Montant TTC
      			<br/>
      			<br/>
