...
function ajoutGroupe()
{
	...
	Cell.innerHTML = "<textarea name=\"designationGrpNew" + newIdGrp + "\" id=\"designationGrpNew" + newIdGrp + "\" cols=\"85\"></textarea><input type=\"hidden\" name=\"idGrpNew" + newIdGrp + "\" id=\"idGrpNew" + newIdGrp + "\" value=\"New" + newIdGrp + "\"/>";
...
function ajoutLigne(idGrp)
{
	...
	Cell.style.borderColor='#84F0FF';
	Cell.style.backgroundColor='#EAF0F7';
	Cell.innerHTML = "<textarea name=\"designation" + newIdHtml + "\" id=\"designation" + newIdHtml + "\" cols=\"85\"></textarea><input type=\"hidden\" name=\"idLine" + newIdHtml + "\" id=\"idLine" + newIdHtml + "\" value=\"" + newIdHtml + "\"/>";
