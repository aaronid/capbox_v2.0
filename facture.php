  ...
  <tbody>
    <tr>
      <td height="32" colspan="2" background="images/fd_nav_ss_menu.png" bgcolor="#F0F0F0" class="componentheading">
          ...
          <a href="facture.php?<?php if (isset($_GET['transforme'])) { echo "transforme=" . $_GET['transforme'] . "&"; } ?><?php if (!empty($id)) { echo "id=" . $id; } ?><?php if (isset($_GET['dup']) && !empty($_GET['dup'])) { echo "dup=" . $_GET['dup']; } ?>"><img src="images/icones/supprimer-la-page-icone-9859-32.png" width="24" height="24" />Effacer la saisie en cours</a>
          <img src="images/menuseparator.png" width="1" height="24" align="middle" />
          ...
          <img src="images/menuseparator.png" width="1" height="24" align="middle" />
          <a href="facture_liste.php"><img src="images/icones/demande-afficher-la-liste-icone-8709-32.png" width="24" height="24" />Retour à la liste des factures</a>
          <img src="images/menuseparator.png" width="1" height="24" align="middle" />
          <a href="acompte_accord_devis_pdf.php?id=<?php echo $facture->id; ?>" target="_blank"><img src="images/icones/imprimante-icone-5571-32.png" width="24" height="24" />Editer acompte</a>
          </span>
      </td>
	</tr>
    <tr>
...
<table width="100%" id="tableArticle" name="tableArticle">
	...
	?>
                        <tr>
                          ...
                          <td align="right" bgcolor="#5289BA"><div class="Style1" id="totalttc"><strong><?php echo $facture->getTTCPriceFormat(); ?></strong></div><input id="Htotalttc" name="Htotalttc" type="hidden" value="<?php echo $facture->getTTCPrice(); ?>"/></td>
                          </tr>
                        <tr>
                          <td bgcolor="#EAF0F7">Acompte perçu (TTC)</td>
                          <td align="right" bgcolor="#EAF0F7"><input title="Saisir le taux de l'acompte." id="acompte" name="acompte" alt="montant" size="10" value="<?php echo $facture->getAcompteFormat(); ?>" onchange="reste();" tabindex="16" />
                    	  <input type="hidden" name="Hacompte" id="Hacompte" value="<?php echo $facture->acompte; ?>" /></td>
                        </tr>
                        <tr>
                          <td bgcolor="#EAF0F7"><strong>Total des avoirs (TTC)</strong></td>
                          <td align="right" bgcolor="#EAF0F7"><div id="avoirttc"><strong><?php echo $facture->getTotalAvoirFormat(); ?></strong></div></td>
                        </tr>
                        <tr>
                          <td bgcolor="#EAF0F7"><strong>Reste à payer (TTC)</strong></td>
                          <td align="right" bgcolor="#EAF0F7"><div id="restettc"><strong><?php echo $facture->getResteAPayerTTCFormat(); ?></strong></div></td>
                        </tr>
                      </tbody>
                    </table>
                  </div></td>
